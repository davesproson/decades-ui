 ...
 *===================================================================*/
const getTraces = (darkMode: boolean) => {
 ...
 *      pressure (hPa)
 *===================================================================*/
// const xyToTphi = (x: number, y: number): [number, number] =>  {
//     const phi = (x + y) / (2 * MA)
//     const t = x - (phi * MA);
...
const getIsobars = (
    ...
    isobars.forEach((t, i) => {
        ...
        let _trace: UnlabelledBackgroundTrace = {
            x: t[0],
            y: t[1],
            showlegend: false,
            mode: 'lines+text',
 ...
 *      plotly.
 *===================================================================*/
const getMassMixRatios = (darkMode: boolean) => {
